...
4. Upload `Generated Theme.zip`
5. Click **Activate**

## Manual Installation

1. Extract `Generated Theme.zip`
2. Copy the `Generated Theme` folder to `/themes/`
3. Go to **Appearance → Themes** in admin
4. Find **Generated Theme** and click **Activate**
...
**Generated**: 2025-12-18T13:40:51.320Z
