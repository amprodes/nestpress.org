...
4. Upload `digital-agency.zip`
5. Click **Activate**

## Manual Installation

1. Extract `digital-agency.zip`
2. Copy the `digital-agency` folder to `/themes/`
3. Go to **Appearance → Themes** in admin
4. Find **digital-agency** and click **Activate**
...
**Generated**: 2026-01-02T13:57:17.765Z
