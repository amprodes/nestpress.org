...
export const enqueueAssets = () => ({
  styles: [
    { handle: 'medicare-style', src: 'style.css', dependencies: [], version: '1.0.0' },
    { handle: 'medicare-global-styles', src: 'assets/css/global-styles.css', dependencies: [], version: '1.0.0' },
  ],
  scripts: [],
});
