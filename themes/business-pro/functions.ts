...
export const enqueueAssets = () => ({
  styles: [
    { handle: 'business-pro-style', src: 'style.css', dependencies: [], version: '1.0.0' },
    { handle: 'business-pro-global-styles', src: 'assets/css/global-styles.css', dependencies: [], version: '1.0.0' },
  ],
  scripts: [],
});
